...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 58857122B25
	for <lists+linux-can@lfdr.de>; Tue, 17 Dec 2019 13:17:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727988AbfLQMRZ (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Tue, 17 Dec 2019 07:17:25 -0500
Received: from relay-b01.edpnet.be ([212.71.1.221]:35074 "EHLO
        relay-b01.edpnet.be" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726858AbfLQMRX (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Tue, 17 Dec 2019 07:17:23 -0500
X-ASG-Debug-ID: 1576585041-0a7ff5137e1cdbc30002-ZXuqFv
Received: from zotac.vandijck-laurijssen.be (77.109.77.154.static.edpnet.net [77.109.77.154]) by relay-b01.edpnet.be with ESMTP id gRW4PghEG44GFWFp; Tue, 17 Dec 2019 13:17:21 +0100 (CET)
...
Received: from x1.vandijck-laurijssen.be (74.250-240-81.adsl-static.isp.belgacom.be [81.240.250.74])
        by zotac.vandijck-laurijssen.be (Postfix) with ESMTPSA id 83AB0BCD901;
        Tue, 17 Dec 2019 13:17:21 +0100 (CET)
From:   Kurt Van Dijck <dev.kurt@vandijck-laurijssen.be>
To:     linux-can@vger.kernel.org
Cc:     Marc Kleine-Budde <mkl@pengutronix.de>,
        Kurt Van Dijck <dev.kurt@vandijck-laurijssen.be>
Subject: [PATCH 08/10] can: c_can: remove unused enum BOSCH_C_CAN_PLATFORM
Date:   Tue, 17 Dec 2019 13:16:32 +0100
X-ASG-Orig-Subj: [PATCH 08/10] can: c_can: remove unused enum BOSCH_C_CAN_PLATFORM
Message-Id: <1576584994-15873-9-git-send-email-dev.kurt@vandijck-laurijssen.be>
...
X-Barracuda-Bayes: INNOCENT GLOBAL 0.6630 1.0000 1.1054
