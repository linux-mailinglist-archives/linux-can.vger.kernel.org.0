...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 9F19D122B2A
	for <lists+linux-can@lfdr.de>; Tue, 17 Dec 2019 13:17:34 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727958AbfLQMR1 (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Tue, 17 Dec 2019 07:17:27 -0500
Received: from relay-b01.edpnet.be ([212.71.1.221]:35089 "EHLO
        relay-b01.edpnet.be" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727766AbfLQMR0 (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Tue, 17 Dec 2019 07:17:26 -0500
X-ASG-Debug-ID: 1576585041-0a7ff5137d1cda670002-ZXuqFv
Received: from zotac.vandijck-laurijssen.be (77.109.77.154.static.edpnet.net [77.109.77.154]) by relay-b01.edpnet.be with ESMTP id GZBBdewLhMWfX978; Tue, 17 Dec 2019 13:17:21 +0100 (CET)
...
Received: from x1.vandijck-laurijssen.be (74.250-240-81.adsl-static.isp.belgacom.be [81.240.250.74])
        by zotac.vandijck-laurijssen.be (Postfix) with ESMTPSA id A0730BCD903;
...
Subject: [PATCH 09/10] can: c_can: support 64 message objects for D_CAN
Date:   Tue, 17 Dec 2019 13:16:33 +0100
X-ASG-Orig-Subj: [PATCH 09/10] can: c_can: support 64 message objects for D_CAN
Message-Id: <1576584994-15873-10-git-send-email-dev.kurt@vandijck-laurijssen.be>
...
X-Barracuda-Bayes: SPAM GLOBAL 0.9903 1.0000 4.2299
X-Barracuda-Spam-Score: 4.73
X-Barracuda-Spam-Status: No, SCORE=4.73 using global scores of TAG_LEVEL=1000.0 QUARANTINE_LEVEL=1000.0 KILL_LEVEL=7.0 tests=BSF_RULE7568M
...
index b0f206d3..47b2587 100644
--- a/drivers/net/can/c_can/Kconfig
+++ b/drivers/net/can/c_can/Kconfig
@@ -21,4 +21,16 @@ config CAN_C_CAN_PCI
 	---help---
...
-
 ...
 {
@@ -737,7 +728,16 @@ static void c_can_do_tx(struct net_device *dev)
 	struct sk_buff *skb;
 	u8 len;
...
+	clr = pend;
 	...
 	while ((idx = ffs(pend))) {
 		idx--;
@@ -847,7 +847,17 @@ static int c_can_read_objects(struct net_device *dev, struct c_can_priv *priv,
...
@@ -858,8 +868,7 @@ static inline u32 c_can_get_pending(struct c_can_priv *priv)
...
+ * has arrived.
  ...
  *
@@ -870,13 +879,6 @@ static int c_can_do_rx_poll(struct net_device *dev)
