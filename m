...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D7C505E8F03
	for <lists+linux-can@lfdr.de>; Sat, 24 Sep 2022 19:44:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233903AbiIXRoy (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Sat, 24 Sep 2022 13:44:54 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53596 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234002AbiIXRov (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Sat, 24 Sep 2022 13:44:51 -0400
Received: from mo4-p00-ob.smtp.rzone.de (mo4-p00-ob.smtp.rzone.de [81.169.146.221])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 179591A81F
        for <linux-can@vger.kernel.org>; Sat, 24 Sep 2022 10:44:46 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1664041479;
    s=strato-dkim-0002; d=hartkopp.net;
    h=Message-Id:Date:Subject:Cc:To:From:Cc:Date:From:Subject:Sender;
    bh=YaFq7zBtOLpEbHCDqQsDJtyfwuEq5Elhz2yfNln76YI=;
    b=
...
Received: from silver.lan
    ...
    with ESMTPSA id ff3b6ay8OHic2c4
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256 bits))
        (Client did not present a certificate);
    Sat, 24 Sep 2022 19:44:38 +0200 (CEST)
...
Subject: [RFC can-next] can: remove obsolete PCH CAN driver
Date:   Sat, 24 Sep 2022 19:44:24 +0200
Message-Id: <20220924174424.86541-1-socketcan@hartkopp.net>
...
@@ -196,18 +196,10 @@ config CAN_XILINXCAN
...
@@ -28,8 +28,7 @@ obj-$(CONFIG_CAN_M_CAN)		+= m_can/
...
@@ -18,7 +18,8 @@ config CAN_C_CAN_PLATFORM
