...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id ED293341D1C
	for <lists+linux-can@lfdr.de>; Fri, 19 Mar 2021 13:42:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230025AbhCSMmS (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Fri, 19 Mar 2021 08:42:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60252 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230049AbhCSMl5 (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Fri, 19 Mar 2021 08:41:57 -0400
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id AD967C061760
...
Received: from gallifrey.ext.pengutronix.de ([2001:67c:670:201:5054:ff:fe8d:eefb] helo=bjornoya.blackshift.org)
        ...
        id 1lNERv-0003Eq-87
        for linux-can@vger.kernel.org; Fri, 19 Mar 2021 13:41:55 +0100
Received: from dspam.blackshift.org (localhost [127.0.0.1])
        by bjornoya.blackshift.org (Postfix) with SMTP id 7E8AF5FA9A0
        for <linux-can@vger.kernel.org>; Fri, 19 Mar 2021 12:41:52 +0000 (UTC)
Received: from hardanger.blackshift.org (unknown [172.20.34.65])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-384) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (Client did not present a certificate)
        by bjornoya.blackshift.org (Postfix) with ESMTPS id 5F3695FA975;
        Fri, 19 Mar 2021 12:41:46 +0000 (UTC)
Received: from blackshift.org (localhost [::1])
        by hardanger.blackshift.org (OpenSMTPD) with ESMTP id da2ebb71;
...
Subject: [PATCH v13 09/11] can: etas_es58x: es58x_fd: add support for the ETAS ES58X_FD CAN USB interfaces
Date:   Fri, 19 Mar 2021 13:41:39 +0100
Message-Id: <20210319124141.247844-10-mkl@pengutronix.de>
...
---
 ...
 drivers/net/can/usb/etas_es58x/es58x_core.h |   1 +
 drivers/net/can/usb/etas_es58x/es58x_fd.c   | 600 ++++++++++++++++++++
 drivers/net/can/usb/etas_es58x/es58x_fd.h   | 221 +++++++
...
index 77634a3ed480..95d0a02e408b 100644
--- a/drivers/net/can/usb/etas_es58x/es58x_core.c
+++ b/drivers/net/can/usb/etas_es58x/es58x_core.c
@@ -35,6 +35,8 @@ MODULE_LICENSE("GPL v2");
...
index 10d40c85d699..659b04ef9b05 100644
--- a/drivers/net/can/usb/etas_es58x/es58x_core.h
+++ b/drivers/net/can/usb/etas_es58x/es58x_core.h
@@ -201,6 +201,7 @@ enum es58x_ret_type {
...
index 6be26f4b32dc..fdd458250e09 100644
