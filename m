...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3F1643AA755
	for <lists+linux-can@lfdr.de>; Thu, 17 Jun 2021 01:17:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234471AbhFPXUA (ORCPT <rfc822;lists+linux-can@lfdr.de>);
...
Received: from mail.kernel-space.org ([195.201.34.187]:38042 "EHLO
        ...
        with ESMTP id S234470AbhFPXT5 (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Wed, 16 Jun 2021 19:19:57 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=kernel-space.org;
        s=20190913; t=1623885469;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=HZnJg2WD1nmtWzoclgStrdlvuU2FNZ5bpyjaV1w9gbs=;
        b=S3MbbYOI7cWEjtH1V+//sRZ2e9L2wOliVNhjFLuip10MhDXxJftvirybAM37uqsVH0BnQJ
        yAdZS1GdXksvlK3OvnO7Ma0P+CmXfLjRyi/KHveSUrM5SytPlwCAF/oWH0bd9xa6Vg86HC
        qU/O/6FsJiEV0uh/iAJxbqUoHZKo9Qk=
Received: from dfj.1.1.1.1 (host-87-8-57-171.retail.telecomitalia.it [87.8.57.171])
        by ziongate (OpenSMTPD) with ESMTPSA id 1b7c820d (TLSv1.3:TLS_AES_256_GCM_SHA384:256:NO);
        Wed, 16 Jun 2021 23:17:49 +0000 (UTC)
...
Subject: [PATCH v2 5/5] can: flexcan: add mcf5441x support
Date:   Thu, 17 Jun 2021 01:16:52 +0200
Message-Id: <20210616231652.738027-5-angelo@kernel-space.org>
