...
Received: from dspam.blackshift.org (localhost [127.0.0.1])
        by bjornoya.blackshift.org (Postfix) with SMTP id 9EA4A5ABDDD
        for <linux-can@vger.kernel.org>; Sat, 12 Dec 2020 17:55:24 +0000 (UTC)
Received: from hardanger.blackshift.org (unknown [172.20.34.65])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-384) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (Client did not present a certificate)
        by bjornoya.blackshift.org (Postfix) with ESMTPS id 6C5BD5ABDAD;
        Sat, 12 Dec 2020 17:55:20 +0000 (UTC)
Received: from blackshift.org (localhost [::1])
        by hardanger.blackshift.org (OpenSMTPD) with ESMTP id 2c4de7e7;
...
Subject: [can-next-rfc 6/7] can: m_can: let m_can_class_allocate_dev() allocate driver specific private data
Date:   Sat, 12 Dec 2020 18:55:17 +0100
Message-Id: <20201212175518.139651-7-mkl@pengutronix.de>
