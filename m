...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 565A83AF575
	for <lists+linux-can@lfdr.de>; Mon, 21 Jun 2021 20:47:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232281AbhFUStg (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Mon, 21 Jun 2021 14:49:36 -0400
Received: from mail.kernel-space.org ([195.201.34.187]:48192 "EHLO
        ...
        with ESMTP id S231455AbhFUStf (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Mon, 21 Jun 2021 14:49:35 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=kernel-space.org;
        s=20190913; t=1624301239;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=Xo8nSP35pwBM6SgdzSmp14hDn56YqcFlPY3fRVGjmUg=;
        b=Is/K8vuMWH/EPNH85J39DiVeeOScnEr6YV+qquLJsZcBEzXU7dqC3NiMSD+KPKAB7JWMag
        z4VS37XzGD57zXX+I9BZN+BgCyZtgXlcGF8n6kM14BGQMBBOCl4piVtzVvs4GEqW2M4HQF
        HYFFLDfV5pvvzKuRRPjzL79Cz8Jw0Eo=
Received: from dfj.bfc.timesys.com (host-87-8-57-171.retail.telecomitalia.it [87.8.57.171])
        by ziongate (OpenSMTPD) with ESMTPSA id 2ee688c9 (TLSv1.3:TLS_AES_256_GCM_SHA384:256:NO);
...
Subject: [PATCH v3 3/5] m68k: m5441x: add flexcan support
Date:   Mon, 21 Jun 2021 20:46:13 +0200
Message-Id: <20210621184615.3345846-3-angelo@kernel-space.org>
...
index 59f7dfe50a4d..5afe27d9a29f 100644
...
+static struct mcf_flexcan_platform_data mcf5441x_flexcan_info = {
+	.clk_src = 1,
