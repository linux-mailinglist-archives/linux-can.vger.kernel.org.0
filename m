...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5791E2BA701
	for <lists+linux-can@lfdr.de>; Fri, 20 Nov 2020 11:07:16 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727426AbgKTKFS (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Fri, 20 Nov 2020 05:05:18 -0500
Received: from mo4-p00-ob.smtp.rzone.de ([81.169.146.219]:25839 "EHLO
        mo4-p00-ob.smtp.rzone.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727156AbgKTKFP (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Fri, 20 Nov 2020 05:05:15 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1605866693;
        s=strato-dkim-0002; d=hartkopp.net;
        h=Message-Id:Date:Subject:Cc:To:From:X-RZG-CLASS-ID:X-RZG-AUTH:From:
        Subject:Sender;
        bh=lra9s+WIlkbONIrtQsT6G1Us5t9LOtA2rSo8UDcJjtA=;
        b=
X-RZG-AUTH: ":P2MHfkW8eP4Mre39l357AZT/I7AY/7nT2yrDxb8mjGrp7owjzFK3JbFk1mS0k+8CejuVLjM8tCwQ"
X-RZG-CLASS-ID: mo00
Received: from silver.lan
        by smtp.strato.de (RZmta 47.3.4 DYNA|AUTH)
        with ESMTPSA id n07f3bwAKA4pWe3
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256 bits))
        (Client did not present a certificate);
        Fri, 20 Nov 2020 11:04:51 +0100 (CET)
From:   Oliver Hartkopp <socketcan@hartkopp.net>
To:     mkl@pengutronix.de
Cc:     linux-can@vger.kernel.org, Oliver Hartkopp <socketcan@hartkopp.net>
Subject: [PATCH v6 4/8 rebased] can: replace can_dlc as variable/element for payload length
Date:   Fri, 20 Nov 2020 11:04:44 +0100
Message-Id: <20201120100444.3199-1-socketcan@hartkopp.net>
...
@@ -346,11 +346,11 @@ static netdev_tx_t mcba_usb_start_xmit(struct sk_buff *skb,
...
--- a/net/can/af_can.c
+++ b/net/can/af_can.c
@@ -886,11 +886,11 @@ static struct pernet_operations can_pernet_ops __read_mostly = {
