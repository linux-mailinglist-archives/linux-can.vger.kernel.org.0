...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A011329E062
	for <lists+linux-can@lfdr.de>; Thu, 29 Oct 2020 02:22:10 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729637AbgJ1WEz (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Wed, 28 Oct 2020 18:04:55 -0400
Received: from mo4-p01-ob.smtp.rzone.de ([85.215.255.50]:23452 "EHLO
        mo4-p01-ob.smtp.rzone.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728148AbgJ1WBO (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Wed, 28 Oct 2020 18:01:14 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1603922462;
        s=strato-dkim-0002; d=hartkopp.net;
        h=References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:
        X-RZG-CLASS-ID:X-RZG-AUTH:From:Subject:Sender;
        bh=yqvdcSu+lys1deX+0h1VxQvcfhuHyeWe1Als8cuG5T4=;
        b=
...
Received: from silver.lan
        ...
        with ESMTPSA id J01b14w9SB100RO
...
Subject: [PATCH 4/4] can: rename can_dlc with len for all struct can_frame users
Date:   Wed, 28 Oct 2020 12:00:33 +0100
Message-Id: <20201028110033.113702-5-socketcan@hartkopp.net>
