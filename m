...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 47E3029E064
	for <lists+linux-can@lfdr.de>; Thu, 29 Oct 2020 02:22:12 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728402AbgJ1WEz (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Wed, 28 Oct 2020 18:04:55 -0400
Received: from mo4-p01-ob.smtp.rzone.de ([85.215.255.50]:22747 "EHLO
        mo4-p01-ob.smtp.rzone.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728183AbgJ1WBH (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Wed, 28 Oct 2020 18:01:07 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1603922458;
        s=strato-dkim-0002; d=hartkopp.net;
        h=References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:
        X-RZG-CLASS-ID:X-RZG-AUTH:From:Subject:Sender;
        bh=bs92VMyu6AwNKPunrOWQy1bLz6nJ0SzlDIn0WBjSwik=;
        b=
...
Received: from silver.lan
        ...
        with ESMTPSA id J01b14w9SB0x0RM
...
Subject: [PATCH 2/4] can: rename get_can_dlc() macro with can_get_cc_len()
Date:   Wed, 28 Oct 2020 12:00:31 +0100
Message-Id: <20201028110033.113702-3-socketcan@hartkopp.net>
