-0700 (PDT)
Precedence: bulk
...
MIME-Version: 1.0
References: <cover.1780908445.git.zhoubinbin@loongson.cn> <ed069249061d105d72d2115b8a05216a60cebffb.1780908445.git.zhoubinbin@loongson.cn>
 <c9598f85-5b17-4d38-855e-c3840a01452f@kernel.org>
In-Reply-To: <c9598f85-5b17-4d38-855e-c3840a01452f@kernel.org>
From: Binbin Zhou <zhoubb.aaron@gmail.com>
Date: Thu, 18 Jun 2026 17:49:33 +0800
X-Gm-Features: AVVi8CcyyPCzTkB66-WLDCleNSyqH5TnWN3nWFuuUuxt5BEfRgLIUMztG9413T8
Message-ID: <CAMpQs4J5vq8U-_1BanyFcn6PYhnws=vuE3Yq1hvSBbLZJC8aEQ@mail.gmail.com>
...
X-Spamd-Result: default: False [-2.16 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	FROM_HAS_DN(0.00)[];
	TAGGED_FROM(0.00)[bounces-7878-lists,linux-can=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
...
X-Rspamd-Queue-Id: 7B83B69F099

Hi Vincent:

Thanks for your detailed review and sorry for the late reply.

On Tue, Jun 9, 2026 at 1:43=E2=80=AFAM Vincent Mailhol <mailhol@kernel.org>=
 wrote:
>
> On 08/06/2026 at 10:49, Binbin Zhou wrote:
> > Add support for the CAN-FD controller integrated into Loongson-2K serie=
s
...
> > diff --git a/drivers/net/can/loongson_canfd.c b/drivers/net/can/loongso=
n_canfd.c
...
> > +#define REG_FRAME_META1_RWCNT                GENMASK(28, 24) /* Read W=
ord Counter */
> > +
...
> > +
> > +/**
> > + * struct loongson_canfd_priv - This definition define CAN driver inst=
ance
...
> > + *     1: to clear the send completion record (LOONGSON_CANFD_TX_STAT[=
BS]).
> > + */
...
> > +
> > +/**
> > + * loongson_canfd_txbuf_freed() - Gets the flag for TX buffer to be se=
nt
> > + * @priv: Pointer to private data
> > + *
...
> > + */
> > +static bool loongson_canfd_txbuf_freed(struct loongson_canfd_priv *pri=
v)
> > +{
...
> > +loongson_canfd_get_txbuf_sts(struct loongson_canfd_priv *priv, u8 buf_=
id)
> > +{
> > +     u32 sts, mask;
> > +
...
>
>         static enum loongson_canfd_txbuf_sts
>         loongson_canfd_get_txbuf_sts(struct loongson_canfd_priv *priv, u8=
 buf_id)
>         {
>                 u32 mask, sts;
>
>                 mask =3D GENMASK(REG_TX_STAT_BS_TX_BASE + 2 * buf_id + 1,
...
>                 return field_get(mask, sts);
>         }
Yes, this way is much clearer and more concise.

>
> > +/**
> > + * loongson_canfd_get_txbuf_id() - Gets the index of a non-idle TX buf=
fer
> > + * @priv: Pointer to private data
...
> > + */
> > +static unsigned int loongson_canfd_get_txbuf_id(struct loongson_canfd_=
priv *priv,
...
> > +
> > +/**
> > + * loongson_canfd_txbuf_is_writable() - Checks if frame can be inserte=
d to TX Buffer
> > + * @priv: Pointer to private data
> > + * @buf_id: Buffer index (0-based)
> > + *
...
> > + */
> > +static bool loongson_canfd_txbuf_is_writable(struct loongson_canfd_pri=
v *priv, u8 buf_id)
> > +{
...
> > +
> > +/**
> > + * loongson_canfd_reset() - Issues software reset request to Loongson =
CANFD
> > + * @ndev: Pointer to net_device structure
> > + *
> > + * Return: 0 for success, -%ETIMEDOUT if CAN controller does not leave=
 reset
>                              ^^^^^^^^^^^
> This part of the documentation does not match the code.

This function appears to not require a return value; `void` should suffice.
>
> > + */
...
> > +
> > +/**
> > + * loongson_canfd_set_btr() - Sets CAN bus bit timing in Loongson CANF=
D
> > + * @ndev: Pointer to net_device structure
...
>
>         int max_ph1_len =3D FIELD_MAX(REG_BTR_FD_PH1);
>
> > +     u32 btr =3D 0;
> > +
...
Just drop it, and the function=E2=80=99s return type can be changed to `voi=
d`.
>
> > +     if (nominal)
> > +             max_ph1_len =3D 63;
...
>
>         if (nominal)
>                 ph1_max =3D FIELD_MAX(REG_BTR_PH1);
>         else
>                 ph1_max =3D FIELD_MAX(REG_BTR_FD_PH1);
>
> (while at it, I renamed to ph1_max because the this is not a length,
> so I am not sure why you put a _len suffix).

This was my mistake; this part of the code wasn=E2=80=99t updated in sync. =
The
bit fields for these two registers differed in older versions of the
controller, but they are now consistent=E2=80=94please see the relevant mac=
ro
definitions.

Therefore, try modifying it as follows:
         ...
         * tseg1 is then split in half and stored into prog_seg and phase_s=
eg1.
         * In Loongson CAN-FD, PROP is 7 bits wide but PH1 only 6, so we mu=
st
...
> > +
> > +/**
> > + * loongson_canfd_set_data_bittiming() - CAN set data bit timing routi=
ne
> > + * @ndev: Pointer to net_device structure
> > + *
> > + * Return: 0 on success, -%EPERM on error
...
> > +
> > +/**
> > + * loongson_canfd_get_auto_tdcv - Get Transmitter Delay Compensation V=
alue
> > + * @ndev: Pointer to net_device structure
...
> > + * Return: 0 on success
> > + */
> > +static int loongson_canfd_get_auto_tdcv(const struct net_device *ndev,=
 u32 *tdcv)
> > +{
> > +     struct loongson_canfd_priv *priv =3D netdev_priv(ndev);
> > +     u32 val;
...
> > +
> > +/**
> > + * loongson_canfd_set_secondary_sample_point() - Set secondary sample =
point in Loongson CANFD
> > + * @ndev: Pointer to net_device structure
> > + *
...
As mentioned earlier, discard `mode` and use `priv->can.ctrlmode` directly.
>
...
> > + *
> > + * This check the drivers state and calls the corresponding modes to s=
et.
> > + *
> > + * Return: 0 on success and failure value on error
> > + */
...
> > +     /* Write Data payload */
> > +     if (!(cf->can_id & CAN_RTR_FLAG)) {
> > +             for (unsigned int i =3D 0; i < cf->len; i +=3D LOONGSON_C=
ANFD_DW_BYTE) {
...
Sorry, this is the old test code=E2=80=94I forgot to update it. Just use `u=
32`:
...
> > + * @ndev: Pointer to net_device structure
> > + *
> > + * Invoked from upper layers to initiate transmission. Uses the next a=
vailable free TX Buffer and
> > + * populates its fields to start the transmission.
> > + *
> > + * Return: %NETDEV_TX_OK on success,
> > + *         %NETDEV_TX_BUSY when no free TX buffer is available, negati=
ve return values reserved
> > + *         for error cases.
> > + */
...
> > +     else
> > +             cf->can_id =3D FIELD_GET(REG_FRAME_META0_ID_BASE, meta0) =
& CAN_SFF_MASK;
> > +
> > +     /* BRS, ESI, RTR Flags */
> > +     cf->flags =3D 0;
...
> framework.
>
> > +     wc =3D FIELD_GET(REG_FRAME_META1_RWCNT, meta1) - 2;
> > +
> > +     /* Data Length Code */
...
> > +
> > +/**
> > + * loongson_canfd_rx() -  Called from CAN ISR to complete the received=
 frame processing
> > + * @ndev: Pointer to net_device structure
> > + *
> > + * This function is invoked from the CAN isr to process the Rx frames.=
 It does minimal
> > + * processing and invokes "netif_receive_skb" to complete further proc=
essing.
> > + * Return: 1 when frame is passed to the network layer, 0 when the fir=
st frame word is read but
...
> > +
> > +/**
> > + * loongson_canfd_read_fault_state() - Reads Loongson CANFD fault stat=
e.
> > + * @ndev: Pointer to net_device structure
> > + *
> > + * Returns: Fault confinement state of controller
> > + */
> > +static enum can_state loongson_canfd_read_fault_state(struct net_devic=
e *ndev)
> > +{
> > +     struct loongson_canfd_priv *priv =3D netdev_priv(ndev);
...
> > +
> > +/**
> > + * loongson_canfd_get_bec() - Reads REC/TEC counter values from contro=
ller
> > + * @priv: Pointer to private data
...
> > + *
> > + * This is the CAN error interrupt and it will check the type of error=
...
> > +     guard(spinlock_irqsave)(&priv->tx_lock);
> > +
> > +     while ((buf_id =3D loongson_canfd_get_txbuf_id(priv, &sts)) < LOO=
NGSON_CANFD_TXBUF_NUM) {
> > +             switch (sts) {
> > +             case TX_BS_VALID:
> > +                     stats->tx_bytes +=3D can_get_echo_skb(ndev, buf_i=
d, NULL);
> > +                     stats->tx_packets++;
> > +                     break;
> > +             case TX_BS_FAIL:
...
reached.
> > +                      * Obviously we should not echo the frame, but al=
so not indicate any
> > +                      * kind of error. If desired, it was already repo=
rted (possible
> > +                      * multiple times) on each arbitration lost.
> > +                      */
> > +                     regmap_read(priv->regmap, LOONGSON_CANFD_TX_FR_CN=
T, &cnt);
> > +                     netdev_warn(ndev, "TXB in FAIL state, TX frame co=
unt: %d\n", cnt);
...
> > +             case TX_BS_CANCEL:
> > +                     /*
> > +                      * We *could* re-queue the frame, but multiqueue/=
abort is
...
> > +             }
> > +
> > +             loongson_canfd_set_txbuf_cmd(ndev, TXT_CMD_SR_CLEAN, buf_=
id);
> > +     }
> > +
> > +     /*
> > +      * Clear the interrupt again. We do not want to receive again int=
errupt
> > +      * for the buffer already handled. If it is the last finished one=
 then
> > +      * it would cause log of spurious interrupt.
> > +      */
> > +     regmap_write(priv->regmap, LOONGSON_CANFD_INT_STAT, REG_INT_STAT_=
TXBHCI);
> > +
...
> > + * @ndev: Pointer to net_device structure
> > + *
> > + * This is the drivers stop routine. It will disable the interrupts an=
d
...
I've checked and tested it, and the controller supports this mode.
