...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2FF6329E671
	for <lists+linux-can@lfdr.de>; Thu, 29 Oct 2020 09:32:50 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728460AbgJ2Ics (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Thu, 29 Oct 2020 04:32:48 -0400
Received: from mo4-p01-ob.smtp.rzone.de ([85.215.255.51]:33624 "EHLO
        mo4-p01-ob.smtp.rzone.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728319AbgJ2Ics (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Thu, 29 Oct 2020 04:32:48 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1603960347;
        s=strato-dkim-0002; d=hartkopp.net;
        h=References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:
        X-RZG-CLASS-ID:X-RZG-AUTH:From:Subject:Sender;
        bh=bs92VMyu6AwNKPunrOWQy1bLz6nJ0SzlDIn0WBjSwik=;
        b=
...
Received: from silver.lan
        ...
        with ESMTPSA id L010bew9T8WQ0Vl
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256 bits))
        (Client did not present a certificate);
        Thu, 29 Oct 2020 09:32:26 +0100 (CET)
...
Subject: [PATCH v3 2/4] can: rename get_can_dlc() macro with can_get_cc_len()
Date:   Thu, 29 Oct 2020 09:32:16 +0100
Message-Id: <20201029083218.41505-3-socketcan@hartkopp.net>
