...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9B8C03431F5
	for <lists+linux-can@lfdr.de>; Sun, 21 Mar 2021 11:42:30 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229846AbhCUKl6 (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Sun, 21 Mar 2021 06:41:58 -0400
Received: from smtp13.smtpout.orange.fr ([80.12.242.135]:20645 "EHLO
        smtp.smtpout.orange.fr" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S229784AbhCUKl3 (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Sun, 21 Mar 2021 06:41:29 -0400
Received: from tomoyo.flets-east.jp ([153.202.107.157])
        by mwinf5d70 with ME
        id iyh52400H3PnFJp03yhR7D; Sun, 21 Mar 2021 11:41:27 +0100
X-ME-Helo: tomoyo.flets-east.jp
X-ME-Auth: bWFpbGhvbC52aW5jZW50QHdhbmFkb28uZnI=
X-ME-Date: Sun, 21 Mar 2021 11:41:27 +0100
X-ME-IP: 153.202.107.157
From:   Vincent Mailhol <mailhol.vincent@wanadoo.fr>
To:     Marc Kleine-Budde <mkl@pengutronix.de>, linux-can@vger.kernel.org
Cc:     Arunachalam Santhanam <arunachalam.santhanam@in.bosch.com>,
        Vincent Mailhol <mailhol.vincent@wanadoo.fr>
Subject: [PATCH v14 1/4] can: etas_es58x: add core support for ETAS ES58X CAN USB interfaces
Date:   Sun, 21 Mar 2021 19:41:00 +0900
Message-Id: <20210321104103.213308-2-mailhol.vincent@wanadoo.fr>
...
---
 ...
 drivers/net/can/usb/etas_es58x/es58x_core.c | 2374 +++++++++++++++++++
 drivers/net/can/usb/etas_es58x/es58x_core.h |  662 ++++++
 5 files changed, 3050 insertions(+)
...
new file mode 100644
index 000000000000..69d506d3e934
--- /dev/null
...
+
+/**
+ * es58x_can_flush_echo_skb() - Reset the echo FIFO.
+ * @netdev: CAN network device.
+ *
...
+			unsigned int frame_len = 0;
+
+			can_free_echo_skb(netdev, i & fifo_mask, &frame_len);
+			netdev_completed_queue(netdev, 1, frame_len);
+		}
...
+ * @netdev: CAN network device.
+ *
+ * Update the echo FIFO and do a bulk send. This function should be
+ * called only once by bulk transmission.
+ *
+ * Return: zero on success, errno when any error occurs.
+ */
...
+ * @netdev: CAN network device.
+ *
+ * Race conditions might appear when trying to use the reset_rx() and
+ * reset_tx() methods (e.g. echo packets might remain in the queue
+ * causing some use after free issues in
...
new file mode 100644
index 000000000000..1c7f7334e678
--- /dev/null
