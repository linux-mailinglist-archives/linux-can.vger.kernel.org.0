...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 117C35E53E6
	for <lists+linux-can@lfdr.de>; Wed, 21 Sep 2022 21:39:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229543AbiIUTje (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Wed, 21 Sep 2022 15:39:34 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49138 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229587AbiIUTjX (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Wed, 21 Sep 2022 15:39:23 -0400
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 19FAEA1D2D
        for <linux-can@vger.kernel.org>; Wed, 21 Sep 2022 12:39:22 -0700 (PDT)
Received: from gallifrey.ext.pengutronix.de ([2001:67c:670:201:5054:ff:fe8d:eefb] helo=bjornoya.blackshift.org)
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <mkl@pengutronix.de>)
        id 1ob5Z2-0001zq-I3
        for linux-can@vger.kernel.org; Wed, 21 Sep 2022 21:39:20 +0200
Received: from dspam.blackshift.org (localhost [127.0.0.1])
        by bjornoya.blackshift.org (Postfix) with SMTP id ED26DE8DC2
        for <linux-can@vger.kernel.org>; Wed, 21 Sep 2022 19:39:19 +0000 (UTC)
Received: from hardanger.blackshift.org (unknown [172.20.34.65])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (Client did not present a certificate)
        by bjornoya.blackshift.org (Postfix) with ESMTPS id EE5B2E8DC0;
        Wed, 21 Sep 2022 19:39:18 +0000 (UTC)
Received: from blackshift.org (localhost [::1])
        by hardanger.blackshift.org (OpenSMTPD) with ESMTP id 83fda76e;
        Wed, 21 Sep 2022 19:39:03 +0000 (UTC)
From:   Marc Kleine-Budde <mkl@pengutronix.de>
To:     linux-can@vger.kernel.org
Cc:     Marc Kleine-Budde <mkl@pengutronix.de>
Subject: [PATCH 2/3] can: gs_usb: convert from usb_control_msg() to usb_control_msg_{send,recv}()
Date:   Wed, 21 Sep 2022 21:39:01 +0200
Message-Id: <20220921193902.575416-3-mkl@pengutronix.de>
...
index bf0a1da27f76..be4530e288d1 100644
...
@@ -1138,26 +1083,21 @@ static struct gs_can *gs_make_candev(unsigned int channel,
 	struct gs_can *dev;
...
@@ -1165,7 +1105,6 @@ static struct gs_can *gs_make_candev(unsigned int channel,
...
@@ -1178,14 +1117,14 @@ static struct gs_can *gs_make_candev(unsigned int channel,
...
+	dev->bt_const.brp_inc = le32_to_cpu(bt_const.brp_inc);
 	...
 	dev->iface = intf;
@@ -1202,13 +1141,13 @@ static struct gs_can *gs_make_candev(unsigned int channel,
...
@@ -1258,45 +1197,35 @@ static struct gs_can *gs_make_candev(unsigned int channel,
...
@@ -1324,64 +1253,51 @@ static int gs_usb_probe(struct usb_interface *intf,
...
@@ -1391,7 +1307,7 @@ static int gs_usb_probe(struct usb_interface *intf,
 	for (i = 0; i < icount; i++) {
...
@@ -1402,7 +1318,6 @@ static int gs_usb_probe(struct usb_interface *intf,
...
@@ -1425,8 +1340,6 @@ static int gs_usb_probe(struct usb_interface *intf,
