...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3CEB529E673
	for <lists+linux-can@lfdr.de>; Thu, 29 Oct 2020 09:33:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730198AbgJ2IdT (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Thu, 29 Oct 2020 04:33:19 -0400
Received: from mo4-p01-ob.smtp.rzone.de ([85.215.255.53]:30917 "EHLO
        mo4-p01-ob.smtp.rzone.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727781AbgJ2IdJ (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Thu, 29 Oct 2020 04:33:09 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1603960386;
        s=strato-dkim-0002; d=hartkopp.net;
        h=Message-Id:Date:Subject:Cc:To:From:X-RZG-CLASS-ID:X-RZG-AUTH:From:
        Subject:Sender;
        bh=eKlU13a+af1tTdYN5I04g/vf3/L1XRIiD0c9Ax7QjZE=;
        b=
...
Received: from silver.lan
        ...
        with ESMTPSA id L010bew9T8X50W7
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256 bits))
        (Client did not present a certificate);
        Thu, 29 Oct 2020 09:33:05 +0100 (CET)
...
Subject: [PATCH testing-only] can-dev: implement len8_dlc in some CAN USB adapters for testing
Date:   Thu, 29 Oct 2020 09:32:58 +0100
Message-Id: <20201029083258.41569-1-socketcan@hartkopp.net>
