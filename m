...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2BCFB3B64DF
	for <lists+linux-can@lfdr.de>; Mon, 28 Jun 2021 17:14:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236354AbhF1PRN (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Mon, 28 Jun 2021 11:17:13 -0400
Received: from smtp12.smtpout.orange.fr ([80.12.242.134]:48392 "EHLO
        smtp.smtpout.orange.fr" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238048AbhF1PPS (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Mon, 28 Jun 2021 11:15:18 -0400
Received: from tomoyo.flets-east.jp ([114.149.34.46])
        by mwinf5d35 with ME
        id NfCP250070zjR6y03fCpkb; Mon, 28 Jun 2021 17:12:51 +0200
X-ME-Helo: tomoyo.flets-east.jp
X-ME-Auth: bWFpbGhvbC52aW5jZW50QHdhbmFkb28uZnI=
X-ME-Date: Mon, 28 Jun 2021 17:12:51 +0200
X-ME-IP: 114.149.34.46
From:   Vincent Mailhol <mailhol.vincent@wanadoo.fr>
To:     Marc Kleine-Budde <mkl@pengutronix.de>, linux-can@vger.kernel.org
Cc:     =?UTF-8?q?Stefan=20M=C3=A4tje?= <Stefan.Maetje@esd.eu>,
        Vincent Mailhol <mailhol.vincent@wanadoo.fr>
Subject: [PATCH v3 2/4] can: bittiming: allow TDC{V,O} to be zero and add can_tdc_const::tdc{v,o,f}_min
Date:   Tue, 29 Jun 2021 00:06:05 +0900
Message-Id: <20210628150607.1128574-3-mailhol.vincent@wanadoo.fr>
...
TDCO's zero values:
  * TDCV = 0 -> TDCV is automatically measured by the transiever.
  * TDCO = 0 -> TDC is off.
...
controllers might specify a lower bound on these. Thus, those minumums
...
index 1a2779d383a4..15652132e315 100644
...
@@ -506,8 +506,11 @@ static const struct can_bittiming_const es58x_fd_data_bittiming_const = {
...
@@ -524,7 +527,7 @@ const struct es58x_parameters es58x_fd_param = {
