Return-Path: <linux-can+bounces-6092-lists+linux-can=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-can@lfdr.de
Delivered-To: lists+linux-can@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 160FFD0BA92
	for <lists+linux-can@lfdr.de>; Fri, 09 Jan 2026 18:31:45 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 87ADC3183BE9
	for <lists+linux-can@lfdr.de>; Fri,  9 Jan 2026 17:23:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 314EF364046;
	Fri,  9 Jan 2026 17:23:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=antispam.mailspamprotection.com header.i=@antispam.mailspamprotection.com header.b="qtUnub/n";
	dkim=fail reason="signature verification failed" (1024-bit key) header.d=valla.it header.i=@valla.it header.b="NUMyac02"
...
Received: from delivery.antispam.mailspamprotection.com (delivery.antispam.mailspamprotection.com [185.56.87.10])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A2613200110
	for <linux-can@vger.kernel.org>; Fri,  9 Jan 2026 17:23:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=pass smtp.client-ip=185.56.87.10
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1767979411; cv=pass; b=SRuqZC5kzflt9dNbCPpKVHicqdBaAapNzTW9bdy69OMaEdmic/DSSMa3aRjCkegoZ4krLMpCLtBTDcmZIOHeTu2JONq3TSQ8VmWAQphv3aKhAFOKmkYcGSYa8Ilwyeky2jVrEa3mOHuR0Dgi2E4sQELBVEh2liS9aQyIpsDjit0=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1767979411; c=relaxed/simple;
	bh=FgN0Ogxc4RNuA2xrnGUJdffuJefyAFkWQEceHXM2OL8=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=t6ITkHeolffI6tNDDYkjDurvq10yh1+jxW26pdAdoHJOol6p1olERQGqASkm3/NLSpJCjwOFjsLknGgpLITiHG6FwyqaTMQAORYmacbhosaQ6YNPjYit+vvXKM7/h6eg6sBJYv9Wms9LwE8VpVviFBdFEkXK/pxfLbtF3HyRmok=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=valla.it; spf=pass smtp.mailfrom=valla.it; dkim=pass (1024-bit key) header.d=antispam.mailspamprotection.com header.i=@antispam.mailspamprotection.com header.b=qtUnub/n; dkim=pass (1024-bit key) header.d=valla.it header.i=@valla.it header.b=NUMyac02; arc=pass smtp.client-ip=185.56.87.10
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=valla.it
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=valla.it
ARC-Seal: i=1; cv=none; a=rsa-sha256; d=outgoing.instance-europe-west4-ckl1.prod.antispam.mailspamprotection.com; s=arckey; t=1767979408;
	 b=;
ARC-Authentication-Results: i=1; outgoing.instance-europe-west4-ckl1.prod.antispam.mailspamprotection.com; smtp.remote-ip=35.214.173.214;
	iprev=pass (214.173.214.35.bc.googleusercontent.com) smtp.remote-ip=35.214.173.214;
	auth=pass (LOGIN) smtp.auth=esm19.siteground.biz;
	dkim=pass header.d=valla.it header.s=default header.a=rsa-sha256;
	arc=none
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed; d=outgoing.instance-europe-west4-ckl1.prod.antispam.mailspamprotection.com; s=arckey; t=1767979408;
	bh=FgN0Ogxc4RNuA2xrnGUJdffuJefyAFkWQEceHXM2OL8=;
	h=In-Reply-To:Content-Type:MIME-Version:References:Message-ID:Subject:Cc:To:
	  From:Date:DKIM-Signature:DKIM-Signature;
	b=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	d=antispam.mailspamprotection.com; s=default; h=CFBL-Feedback-ID:CFBL-Address
	:Content-Type:MIME-Version:Message-ID:Subject:Cc:To:From:Date:Reply-To:
	List-Unsubscribe:Content-Transfer-Encoding;
	bh=nAvpMyz5NMbxAiLyv8wyVElNmvVAkGgHeiz8yqpVg8E=; b=qtUnub/n/118Mft4d8SlbSIB2a
	8pqK7CYGcMggsQKs4cD20U7rHviE+1cJRGE3DL9bcScMXsGYzywJn2jRTH1P2jZneM4ffmQb2D12a
	TARu2NCIHMQxXNDGqFSFF2iU4cCfBPdT4hjfO8fNLonsj2DAykTPOCqaafYe3ro3jmgc=;
Received: from 214.173.214.35.bc.googleusercontent.com ([35.214.173.214] helo=esm19.siteground.biz)
	by instance-europe-west4-ckl1.prod.antispam.mailspamprotection.com with esmtpsa  (TLS1.3) tls TLS_AES_256_GCM_SHA384
	(Exim 4.98.1)
	(envelope-from <francesco@valla.it>)
	id 1veGCj-00000008OiA-3vIv
	for linux-can@vger.kernel.org;
	Fri, 09 Jan 2026 17:23:21 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=valla.it;
	s=default; h=Subject:Cc:To:From:Date:list-help:list-unsubscribe:
	list-subscribe:list-post:list-owner:list-archive;
	bh=nAvpMyz5NMbxAiLyv8wyVElNmvVAkGgHeiz8yqpVg8E=; b=NUMyac02Lc983zHh8kKS/4+uwj
	6yz+b1oPWXSXWPy2wrD0ZQwXwC+9wqnNDQt7HDavwZwN2VgRt96wBF/EJjy2ZxAGgRJhyV1psmN2g
	5zozJA8ljp/EG98K9PEiKlfukFfNnk4mwO5M7bIF4k4UdmP9Ot57uGDbTvBkQJUl4J5U=;
Received: from [95.248.141.113] (port=59831 helo=bywater)
	by esm19.siteground.biz with esmtpsa  (TLS1.3) tls TLS_AES_256_GCM_SHA384
	(Exim 4.98.1)
	(envelope-from <francesco@valla.it>)
	id 1veGCW-00000000FBO-0Qvl;
	Fri, 09 Jan 2026 17:23:04 +0000
Date: Fri, 9 Jan 2026 18:23:02 +0100
...
Message-ID: <aWE5duyvXCuwsMAn@bywater>
...
X-Source-Args: 
X-Source-Dir: 
X-SGantispam-id: 6b6642165a9717dad612671c4f1f7b6e
AntiSpam-DLS: false
AntiSpam-DLSP: 
AntiSpam-DLSRS: 
AntiSpam-TS: 1.0
CFBL-Address: feedback@antispam.mailspamprotection.com; report=arf
CFBL-Feedback-ID: 1veGCj-00000008OiA-3vIv-feedback@antispam.mailspamprotection.com
Authentication-Results: outgoing.instance-europe-west4-ckl1.prod.antispam.mailspamprotection.com;
	iprev=pass (214.173.214.35.bc.googleusercontent.com) smtp.remote-ip=35.214.173.214;
	auth=pass (LOGIN) smtp.auth=esm19.siteground.biz;
	dkim=pass header.d=valla.it header.s=default header.a=rsa-sha256;
	arc=none
