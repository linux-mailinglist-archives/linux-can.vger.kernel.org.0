...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 90BEED3D8D
	for <lists+linux-can@lfdr.de>; Fri, 11 Oct 2019 12:39:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727654AbfJKKjN (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Fri, 11 Oct 2019 06:39:13 -0400
Received: from metis.ext.pengutronix.de ([85.220.165.71]:42391 "EHLO
        metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726290AbfJKKjN (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Fri, 11 Oct 2019 06:39:13 -0400
Received: from heimdall.vpn.pengutronix.de ([2001:67c:670:205:1d::14] helo=blackshift.org)
        by metis.ext.pengutronix.de with esmtp (Exim 4.92)
        (envelope-from <mkl@pengutronix.de>)
        id 1iIsKF-0004pb-Uf; Fri, 11 Oct 2019 12:39:12 +0200
From:   Marc Kleine-Budde <mkl@pengutronix.de>
To:     linux-can@vger.kernel.org
Cc:     Jeroen Hofstee <jhofstee@victronenergy.com>,
        Marc Kleine-Budde <mkl@pengutronix.de>
Subject: [PATCH v3] can: ti_hecc: add fifo overflow error reporting
Date:   Fri, 11 Oct 2019 12:39:09 +0200
Message-Id: <20191011103909.19908-1-mkl@pengutronix.de>
...
the lowest priority mailbox and increment the rx_over_errors when
receive message lost is set. Drop the message itself in that case, since
it might be partially updated.
...
I've moved the error counter handling to rx-offload.

changes since v2:
- ti_hecc_mailbox_read(): check for overwrite bit _after_ reading the mailbox
  Thanks to Jeroen Hofstee for explaining me the details.

 drivers/net/can/ti_hecc.c | 36 +++++++++++++++++++++++++++++++-----
 1 file changed, 31 insertions(+), 5 deletions(-)

diff --git a/drivers/net/can/ti_hecc.c b/drivers/net/can/ti_hecc.c
index 6ea29126c60b..15869605fd67 100644
