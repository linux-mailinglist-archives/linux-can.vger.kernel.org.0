...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6BF4329E672
	for <lists+linux-can@lfdr.de>; Thu, 29 Oct 2020 09:33:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728147AbgJ2IdB (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Thu, 29 Oct 2020 04:33:01 -0400
Received: from mo4-p01-ob.smtp.rzone.de ([85.215.255.52]:35405 "EHLO
        mo4-p01-ob.smtp.rzone.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728404AbgJ2IdB (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Thu, 29 Oct 2020 04:33:01 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1603960348;
        s=strato-dkim-0002; d=hartkopp.net;
        h=References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:
        X-RZG-CLASS-ID:X-RZG-AUTH:From:Subject:Sender;
        bh=JTSwjGkGscTnf6Z/RuBXyhTv4mca8yjJXoFyB7sWG9Y=;
        b=
...
Received: from silver.lan
        ...
        with ESMTPSA id L010bew9T8WR0Vn
...
Subject: [PATCH v3 4/4] can: replace can_dlc as variable/element for payload length
Date:   Thu, 29 Oct 2020 09:32:18 +0100
Message-Id: <20201029083218.41505-5-socketcan@hartkopp.net>
...
---
 ...
 41 files changed, 234 insertions(+), 234 deletions(-)

diff --git a/Documentation/networking/can.rst b/Documentation/networking/can.rst
index ff05cbd05e0d..34b248727e53 100644
--- a/Documentation/networking/can.rst
+++ b/Documentation/networking/can.rst
@@ -233,11 +233,11 @@ in include/linux/can.h:
...
@@ -395,11 +395,11 @@ all structure elements can be used as-is - only the data[] becomes extended.
...
@@ -1324,11 +1324,11 @@ CAN FD (Flexible Data Rate) Driver Support
...
index 41b897965376..45018fbad35f 100644
