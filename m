...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id C820D2C6FC
	for <lists+linux-can@lfdr.de>; Tue, 28 May 2019 14:49:29 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727228AbfE1Mt3 (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Tue, 28 May 2019 08:49:29 -0400
Received: from mail-lj1-f196.google.com ([209.85.208.196]:38006 "EHLO
        mail-lj1-f196.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726973AbfE1Mt2 (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Tue, 28 May 2019 08:49:28 -0400
Received: by mail-lj1-f196.google.com with SMTP id 14so17587865ljj.5
        for <linux-can@vger.kernel.org>; Tue, 28 May 2019 05:49:24 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=N42r3MWwVhQVOJQLfWKkE/LKlfG2g1ZFl/PwEQpKyYc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=N42r3MWwVhQVOJQLfWKkE/LKlfG2g1ZFl/PwEQpKyYc=;
        b=
X-Gm-Message-State: APjAAAX0d0TLrOpVBOojJpxwRL97e1lyMN4bxaDxKhr3w6Ob2CzFQvPN
        bVDqzZusfG90kdhMQ2izqrdqjtQ93hM=
X-Google-Smtp-Source: APXvYqxdfY8pyaRPpIUwlnG3gMLYQhHaxoUODu0PtyWmut5bBABAIF1i7rg9J33G6n2MfPLCOwwc2w==
X-Received: by 2002:a2e:8741:: with SMTP id q1mr41840239ljj.97.1559047762783;
        Tue, 28 May 2019 05:49:22 -0700 (PDT)
Received: from localhost.localdomain (h-68-244.A785.priv.bahnhof.se. [155.4.68.244])
        by smtp.gmail.com with ESMTPSA id v14sm2868146lfb.50.2019.05.28.05.49.21
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Tue, 28 May 2019 05:49:21 -0700 (PDT)
...
Subject: [PATCH v3 RESEND] can: Add driver for Kvaser PCIEcan devices
Date:   Tue, 28 May 2019 14:48:21 +0200
Message-Id: <20190528124821.15188-1-jimmyassarsson@gmail.com>
...
From: Henning Colliander <henning.colliander@evidente.se>
...
Changes in v3:
  ...
  - Use iopoll, where appropriate
  - Use u8, instead of uint8_t
  - Use ARRAY_SIZE(), where appropriate
  - Drop support for generating error frames
  - Update stats, even if alloc_can_err_skb() fails
  - Remove data member from struct kvaser_pciefd_rx_packet, and skip
    intermediate memcpy() in kvaser_pciefd_handle_data_packet()
  - Call can_bus_off() only if restart-ms is 0
...
index 000000000000..3af747cbbde4
--- /dev/null
