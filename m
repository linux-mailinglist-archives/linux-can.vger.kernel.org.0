...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 184733431F6
	for <lists+linux-can@lfdr.de>; Sun, 21 Mar 2021 11:42:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229826AbhCUKl7 (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Sun, 21 Mar 2021 06:41:59 -0400
Received: from smtp13.smtpout.orange.fr ([80.12.242.135]:41874 "EHLO
        smtp.smtpout.orange.fr" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S229834AbhCUKlq (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Sun, 21 Mar 2021 06:41:46 -0400
Received: from tomoyo.flets-east.jp ([153.202.107.157])
        by mwinf5d70 with ME
        id iyh52400H3PnFJp03yhj8Y; Sun, 21 Mar 2021 11:41:44 +0100
X-ME-Helo: tomoyo.flets-east.jp
X-ME-Auth: bWFpbGhvbC52aW5jZW50QHdhbmFkb28uZnI=
X-ME-Date: Sun, 21 Mar 2021 11:41:44 +0100
X-ME-IP: 153.202.107.157
From:   Vincent Mailhol <mailhol.vincent@wanadoo.fr>
To:     Marc Kleine-Budde <mkl@pengutronix.de>, linux-can@vger.kernel.org
Cc:     Arunachalam Santhanam <arunachalam.santhanam@in.bosch.com>,
        Vincent Mailhol <mailhol.vincent@wanadoo.fr>
Subject: [PATCH v14 3/4] can: etas_es58x: add support for the ETAS ES58X_FD CAN USB interfaces
Date:   Sun, 21 Mar 2021 19:41:02 +0900
Message-Id: <20210321104103.213308-4-mailhol.vincent@wanadoo.fr>
...
---
 ...
 drivers/net/can/usb/etas_es58x/es58x_fd.c   | 575 ++++++++++++++++++++
 drivers/net/can/usb/etas_es58x/es58x_fd.h   | 243 +++++++++
 5 files changed, 840 insertions(+), 2 deletions(-)
...
index b0c4297244ca..7b9b993c0b5b 100644
--- a/drivers/net/can/usb/etas_es58x/es58x_core.c
+++ b/drivers/net/can/usb/etas_es58x/es58x_core.c
@@ -29,10 +29,14 @@ MODULE_LICENSE("GPL v2");
...
@@ -2225,6 +2229,18 @@ static int es58x_init_es58x_dev(struct usb_interface *intf,
...
index 3f7a2c91a1b8..f0cf88a96816 100644
...
@@ -197,6 +200,7 @@ enum es58x_ret_type {
...
index 000000000000..a4e0867c9d4c
--- /dev/null
