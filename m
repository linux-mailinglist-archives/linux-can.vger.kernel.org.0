...
Received: from dspam.blackshift.org (localhost [127.0.0.1])
        by bjornoya.blackshift.org (Postfix) with SMTP id 46D15608725
        for <linux-can@vger.kernel.org>; Tue,  6 Apr 2021 11:16:26 +0000 (UTC)
Received: from hardanger.blackshift.org (unknown [172.20.34.65])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-384) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (Client did not present a certificate)
        by bjornoya.blackshift.org (Postfix) with ESMTPS id 4F4E2608709;
        Tue,  6 Apr 2021 11:16:24 +0000 (UTC)
Received: from blackshift.org (localhost [::1])
        by hardanger.blackshift.org (OpenSMTPD) with ESMTP id 8e2e41a0;
...
Subject: [can-next-rfc 07/10] can: peak_usb: pcan_usb_get_serial(): remove error message from error path
Date:   Tue,  6 Apr 2021 13:16:19 +0200
Message-Id: <20210406111622.1874957-8-mkl@pengutronix.de>
