Return-Path: <linux-can+bounces-6895-lists+linux-can=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-can@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id aN4VDXN0qGm5ugAAu9opvQ
	(envelope-from <linux-can+bounces-6895-lists+linux-can=lfdr.de@vger.kernel.org>)
	for <lists+linux-can@lfdr.de>; Wed, 04 Mar 2026 19:05:39 +0100
X-Original-To: lists+linux-can@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [104.64.211.4])
	by mail.lfdr.de (Postfix) with ESMTPS id 38B29205B4B
	for <lists+linux-can@lfdr.de>; Wed, 04 Mar 2026 19:05:38 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id 3B58430106BE
	for <lists+linux-can@lfdr.de>; Wed,  4 Mar 2026 18:01:37 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D99433D5655;
...
X-Spamd-Result: default: False [1.34 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-6895-lists,linux-can=lfdr.de];
	RCPT_COUNT_TWELVE(0.00)[28];
	MIME_TRACE(0.00)[0:+];
	URIBL_MULTI_FAIL(0.00)[linaro.org:server fail,samsung.com:server fail,hansenpartnership.com:server fail,nxp.com:server fail,sin.lore.kernel.org:server fail,oracle.com:server fail];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[nxp.com:dkim,nxp.com:email,nxp.com:mid,sin.lore.kernel.org:rdns,sin.lore.kernel.org:helo,samsung.com:email,linaro.org:email,hansenpartnership.com:email,oracle.com:email]
