...
Received: from dspam.blackshift.org (localhost [127.0.0.1])
        by bjornoya.blackshift.org (Postfix) with SMTP id 4F6986D1CCC
        for <linux-can@vger.kernel.org>; Wed,  5 Jan 2022 15:43:06 +0000 (UTC)
Received: from hardanger.blackshift.org (unknown [172.20.34.65])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (Client did not present a certificate)
        by bjornoya.blackshift.org (Postfix) with ESMTPS id 1D5A16D1C9C;
        Wed,  5 Jan 2022 15:43:03 +0000 (UTC)
Received: from blackshift.org (localhost [::1])
        by hardanger.blackshift.org (OpenSMTPD) with ESMTP id 8ac65dfa;
...
Subject: [PATCH 12/13] can: mcp251xfd: move ring init into separate function
Date:   Wed,  5 Jan 2022 16:42:59 +0100
Message-Id: <20220105154300.1258636-13-mkl@pengutronix.de>
