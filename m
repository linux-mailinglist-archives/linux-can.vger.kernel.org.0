...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 8AC3F122B2C
	for <lists+linux-can@lfdr.de>; Tue, 17 Dec 2019 13:17:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727941AbfLQMR2 (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Tue, 17 Dec 2019 07:17:28 -0500
Received: from relay-b01.edpnet.be ([212.71.1.221]:35075 "EHLO
        relay-b01.edpnet.be" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727981AbfLQMR0 (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Tue, 17 Dec 2019 07:17:26 -0500
X-ASG-Debug-ID: 1576585041-0a7ff5137e1cdbc30001-ZXuqFv
Received: from zotac.vandijck-laurijssen.be (77.109.77.154.static.edpnet.net [77.109.77.154]) by relay-b01.edpnet.be with ESMTP id sFnO3etoT6kxlueJ for <linux-can@vger.kernel.org>; Tue, 17 Dec 2019 13:17:21 +0100 (CET)
...
Received: from x1.vandijck-laurijssen.be (74.250-240-81.adsl-static.isp.belgacom.be [81.240.250.74])
        by zotac.vandijck-laurijssen.be (Postfix) with ESMTPSA id 1E903BCD8F5;
        Tue, 17 Dec 2019 13:17:21 +0100 (CET)
From:   Kurt Van Dijck <dev.kurt@vandijck-laurijssen.be>
To:     linux-can@vger.kernel.org
Cc:     Kurt Van Dijck <dev.kurt@vandijck-laurijssen.be>
Subject: [PATCH 02/10] can: rx-offload: add skb queue for use during ISR
Date:   Tue, 17 Dec 2019 13:16:26 +0100
X-ASG-Orig-Subj: [PATCH 02/10] can: rx-offload: add skb queue for use during ISR
Message-Id: <1576584994-15873-3-git-send-email-dev.kurt@vandijck-laurijssen.be>
...
X-Barracuda-Bayes: INNOCENT GLOBAL 0.8652 1.0000 2.8618
X-Barracuda-Spam-Score: 2.86
X-Barracuda-Spam-Status: No, SCORE=2.86 using global scores of TAG_LEVEL=1000.0 QUARANTINE_LEVEL=1000.0 KILL_LEVEL=7.0 tests=
