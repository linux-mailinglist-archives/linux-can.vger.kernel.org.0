Return-Path: <linux-can+bounces-108-lists+linux-can=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-can@lfdr.de
Delivered-To: lists+linux-can@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 663F78261D7
	for <lists+linux-can@lfdr.de>; Sat,  6 Jan 2024 23:07:16 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 7CC021C20E53
	for <lists+linux-can@lfdr.de>; Sat,  6 Jan 2024 22:07:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7B0FD101E9;
	Sat,  6 Jan 2024 22:07:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=hartkopp.net header.i=@hartkopp.net header.b="Lz8c5UQK";
	dkim=permerror (0-bit key) header.d=hartkopp.net header.i=@hartkopp.net header.b="E8N3rAzl"
X-Original-To: linux-can@vger.kernel.org
Received: from mo4-p00-ob.smtp.rzone.de (mo4-p00-ob.smtp.rzone.de [85.215.255.21])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2CE2C101D0
	for <linux-can@vger.kernel.org>; Sat,  6 Jan 2024 22:07:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=hartkopp.net
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=hartkopp.net
ARC-Seal: i=1; a=rsa-sha256; t=1704578630; cv=none;
    d=strato.com; s=strato-dkim-0002;
    b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; t=1704578630;
    s=strato-dkim-0002; d=strato.com;
    h=In-Reply-To:From:References:To:Subject:Date:Message-ID:Cc:Date:From:
    Subject:Sender;
    bh=F9dUiKgGSC11vLTeBnTlAMvsi5wpmyBQGdE3qlleY1Y=;
    b=
ARC-Authentication-Results: i=1; strato.com;
    arc=none;
    dkim=none
X-RZG-CLASS-ID: mo00
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1704578630;
    s=strato-dkim-0002; d=hartkopp.net;
    h=In-Reply-To:From:References:To:Subject:Date:Message-ID:Cc:Date:From:
    Subject:Sender;
    bh=F9dUiKgGSC11vLTeBnTlAMvsi5wpmyBQGdE3qlleY1Y=;
    b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; t=1704578630;
    s=strato-dkim-0003; d=hartkopp.net;
    h=In-Reply-To:From:References:To:Subject:Date:Message-ID:Cc:Date:From:
    Subject:Sender;
    bh=F9dUiKgGSC11vLTeBnTlAMvsi5wpmyBQGdE3qlleY1Y=;
    b=E8N3rAzlI+dQlhAQS7xqpTsn9HxdmhGnWqAJZx2JIpFDY/J7KnCq0z4A/QBN3ZOLMY
    QNWVA1eyRO0UAa7Wk5Aw==
X-RZG-AUTH: ":P2MHfkW8eP4Mre39l357AZT/I7AY/7nT2yrDxb8mjG14FZxedJy6qgO1qCHSa1GLptZHusl129OHEdFr0USIYwo8qy03NdWbX99B5c04yTDGgA=="
Received: from [IPV6:2a00:6020:4a8e:5010:66f5:82c7:b412:7bdd]
    by smtp.strato.de (RZmta 49.10.0 AUTH)
    with ESMTPSA id Kf147a006M3o9VN
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256 bits))
	(Client did not present a certificate);
    Sat, 6 Jan 2024 23:03:50 +0100 (CET)
Message-ID: <19ff071b-e248-46e1-8a78-40ba84f3943c@hartkopp.net>
Date: Sat, 6 Jan 2024 23:03:43 +0100
Precedence: bulk
...
To: linux-can@vger.kernel.org, mkl@pengutronix.de, mailhol.vincent@wanadoo.fr
