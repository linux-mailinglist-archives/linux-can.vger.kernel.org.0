...
Received: from dspam.blackshift.org (localhost [127.0.0.1])
        by bjornoya.blackshift.org (Postfix) with SMTP id 81F855FA992
        for <linux-can@vger.kernel.org>; Fri, 19 Mar 2021 12:41:50 +0000 (UTC)
Received: from hardanger.blackshift.org (unknown [172.20.34.65])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-384) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (Client did not present a certificate)
        by bjornoya.blackshift.org (Postfix) with ESMTPS id D401B5FA96B;
        Fri, 19 Mar 2021 12:41:44 +0000 (UTC)
Received: from blackshift.org (localhost [::1])
        by hardanger.blackshift.org (OpenSMTPD) with ESMTP id 7d4f2d4f;
...
Subject: [PATCH v13 06/11] can: etas_es58x: add support for ETAS ES581.4 CAN USB interface
Date:   Fri, 19 Mar 2021 13:41:36 +0100
Message-Id: <20210319124141.247844-7-mkl@pengutronix.de>
...
---
 ...
 drivers/net/can/usb/etas_es58x/es581_4.h    | 189 +++++++
...
index 06a1fad105df..388f9b31bea0 100644
...
index d6a114a7e090..77634a3ed480 100644
...
index ba6cdb9dfcf4..10d40c85d699 100644
--- a/drivers/net/can/usb/etas_es58x/es58x_core.h
+++ b/drivers/net/can/usb/etas_es58x/es58x_core.h
@@ -200,6 +200,7 @@ enum es58x_ret_type {
 };
