...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3317B127895
	for <lists+linux-can@lfdr.de>; Fri, 20 Dec 2019 10:56:37 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727252AbfLTJ4g (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Fri, 20 Dec 2019 04:56:36 -0500
Received: from relay-b03.edpnet.be ([212.71.1.220]:56307 "EHLO
        relay-b03.edpnet.be" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727192AbfLTJ4f (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Fri, 20 Dec 2019 04:56:35 -0500
X-ASG-Debug-ID: 1576835792-0a88183884185f490001-ZXuqFv
Received: from zotac.vandijck-laurijssen.be (77.109.77.154.static.edpnet.net [77.109.77.154]) by relay-b03.edpnet.be with ESMTP id DfXIk2ZlZwdPZHbL; Fri, 20 Dec 2019 10:56:32 +0100 (CET)
...
Received: from x1.vandijck-laurijssen.be (74.250-240-81.adsl-static.isp.belgacom.be [81.240.250.74])
        by zotac.vandijck-laurijssen.be (Postfix) with ESMTPSA id 9AB78BD9C00;
        Fri, 20 Dec 2019 10:56:32 +0100 (CET)
From:   Kurt Van Dijck <dev.kurt@vandijck-laurijssen.be>
To:     linux-can@vger.kernel.org
Cc:     Marc Kleine-Budde <mkl@pengutronix.de>,
        Kurt Van Dijck <dev.kurt@vandijck-laurijssen.be>
Subject: [PATCH 03/11] can: c_can: register_c_can_dev(): convert to goto style error handling
Date:   Fri, 20 Dec 2019 10:55:19 +0100
X-ASG-Orig-Subj: [PATCH 03/11] can: c_can: register_c_can_dev(): convert to goto style error handling
Message-Id: <1576835727-2956-4-git-send-email-dev.kurt@vandijck-laurijssen.be>
...
X-Barracuda-Bayes: INNOCENT GLOBAL 0.4696 1.0000 0.0000
