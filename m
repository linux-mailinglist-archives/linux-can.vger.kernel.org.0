...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2BF932F1067
	for <lists+linux-can@lfdr.de>; Mon, 11 Jan 2021 11:47:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729418AbhAKKrC (ORCPT <rfc822;lists+linux-can@lfdr.de>);
...
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0E85DC0617B0
...
Received: from dspam.blackshift.org (localhost [127.0.0.1])
        by bjornoya.blackshift.org (Postfix) with SMTP id 937765BF7D9
        for <linux-can@vger.kernel.org>; Mon, 11 Jan 2021 10:45:43 +0000 (UTC)
Received: from hardanger.blackshift.org (unknown [172.20.34.65])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-384) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (Client did not present a certificate)
        by bjornoya.blackshift.org (Postfix) with ESMTPS id A648A5BF7C0;
        Mon, 11 Jan 2021 10:45:40 +0000 (UTC)
Received: from blackshift.org (localhost [::1])
        by hardanger.blackshift.org (OpenSMTPD) with ESMTP id ebdf8825;
...
Subject: [net-next v2 13/15] can: dev: can_get_echo_skb(): extend to return can frame length
Date:   Mon, 11 Jan 2021 11:45:27 +0100
Message-Id: <20210111104529.657057-14-mkl@pengutronix.de>
