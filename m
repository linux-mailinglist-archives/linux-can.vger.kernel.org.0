Return-Path: <linux-can+bounces-7422-lists+linux-can=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-can@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id AAV4GUvG8WkbkQEAu9opvQ
	(envelope-from <linux-can+bounces-7422-lists+linux-can=lfdr.de@vger.kernel.org>)
	for <lists+linux-can@lfdr.de>; Wed, 29 Apr 2026 10:50:19 +0200
X-Original-To: lists+linux-can@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id F10D8491594
	for <lists+linux-can@lfdr.de>; Wed, 29 Apr 2026 10:50:18 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id E6F9330065D8
	for <lists+linux-can@lfdr.de>; Wed, 29 Apr 2026 08:50:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 832A4347503;
...
X-Spamd-Result: default: False [1.34 / 15.00];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[sto.lore.kernel.org:helo,sto.lore.kernel.org:rdns,Nvidia.com:dkim,nvidia.com:mid,nvidia.com:email,baylibre.com:email];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-7422-lists,linux-can=lfdr.de];
	MIME_TRACE(0.00)[0:+];
	...
	FROM_NEQ_ENVFROM(0.00)[petrm@nvidia.com,linux-can@vger.kernel.org];
	FROM_HAS_DN(0.00)[];
