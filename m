...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 86B0B29ECEE
	for <lists+linux-can@lfdr.de>; Thu, 29 Oct 2020 14:31:37 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725791AbgJ2Nbg (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Thu, 29 Oct 2020 09:31:36 -0400
Received: from mo4-p00-ob.smtp.rzone.de ([81.169.146.219]:24972 "EHLO
        mo4-p00-ob.smtp.rzone.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725787AbgJ2Nbg (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Thu, 29 Oct 2020 09:31:36 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1603978290;
        s=strato-dkim-0002; d=hartkopp.net;
        h=Message-Id:Date:Subject:Cc:To:From:X-RZG-CLASS-ID:X-RZG-AUTH:From:
        Subject:Sender;
        bh=WOeMLq2eP1k8aCyn1NQqdQPpZNzEL8jCqwHmd80X+bY=;
        b=
X-RZG-AUTH: ":P2MHfkW8eP4Mre39l357AZT/I7AY/7nT2yrDxb8mjGrp7owjzFK3JbFk1mS0k+8CejudJy0jsSi9nA=="
X-RZG-CLASS-ID: mo00
Received: from silver.lan
        by smtp.strato.de (RZmta 47.3.0 DYNA|AUTH)
        with ESMTPSA id L010bew9TDVT1vl
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256 bits))
        (Client did not present a certificate);
        Thu, 29 Oct 2020 14:31:29 +0100 (CET)
...
Subject: [PATCH testing-only v2] can-dev: implement len8_dlc in some CAN USB adapters for testing
Date:   Thu, 29 Oct 2020 14:31:23 +0100
Message-Id: <20201029133123.2196-1-socketcan@hartkopp.net>
...
v2: fix introduced can_frame pointer assingment in pcan_usb_fd.c
