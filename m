...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1D0283431F4
	for <lists+linux-can@lfdr.de>; Sun, 21 Mar 2021 11:42:30 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229784AbhCUKl6 (ORCPT <rfc822;lists+linux-can@lfdr.de>);
        Sun, 21 Mar 2021 06:41:58 -0400
Received: from smtp13.smtpout.orange.fr ([80.12.242.135]:41582 "EHLO
        smtp.smtpout.orange.fr" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S229826AbhCUKlh (ORCPT
        <rfc822;linux-can@vger.kernel.org>); Sun, 21 Mar 2021 06:41:37 -0400
Received: from tomoyo.flets-east.jp ([153.202.107.157])
        by mwinf5d70 with ME
        id iyh52400H3PnFJp03yha7x; Sun, 21 Mar 2021 11:41:35 +0100
X-ME-Helo: tomoyo.flets-east.jp
X-ME-Auth: bWFpbGhvbC52aW5jZW50QHdhbmFkb28uZnI=
X-ME-Date: Sun, 21 Mar 2021 11:41:35 +0100
X-ME-IP: 153.202.107.157
From:   Vincent Mailhol <mailhol.vincent@wanadoo.fr>
To:     Marc Kleine-Budde <mkl@pengutronix.de>, linux-can@vger.kernel.org
Cc:     Arunachalam Santhanam <arunachalam.santhanam@in.bosch.com>,
        Vincent Mailhol <mailhol.vincent@wanadoo.fr>
Subject: [PATCH v14 2/4] can: etas_es58x: add support for ETAS ES581.4 CAN USB interface
Date:   Sun, 21 Mar 2021 19:41:01 +0900
Message-Id: <20210321104103.213308-3-mailhol.vincent@wanadoo.fr>
...
---
 ...
 drivers/net/can/usb/etas_es58x/es581_4.c    | 499 ++++++++++++++++++++
...
index 000000000000..a4b21dfd1bff
--- /dev/null
...
+		return ret;
+
+	rx_cmd_ret_u32 = get_unaligned_le32(&rx_cmd_ret->rx_cmd_ret_le32);
...
index 69d506d3e934..b0c4297244ca 100644
--- a/drivers/net/can/usb/etas_es58x/es58x_core.c
+++ b/drivers/net/can/usb/etas_es58x/es58x_core.c
@@ -28,9 +28,11 @@ MODULE_LICENSE("GPL v2");
...
@@ -2217,6 +2219,12 @@ static int es58x_init_es58x_dev(struct usb_interface *intf,
 		return ret;
...
index 1c7f7334e678..3f7a2c91a1b8 100644
...
@@ -194,6 +196,7 @@ enum es58x_ret_type {
 };
